import exportTableToXLSX from '../exportToXLSX';
...
if(select('#reportsTable') != null){
    ...
    //exportBtn Event
    addEvent('click',select('#btnExport'),()=>exportTableToXLSX('reportsTable',filename));
...
reportLinks.forEach(link => {
    link.addEventListener('click',()=>{window.location.href = `${link.getAttribute('route')}`});
});
