...
{{--         
    ...
    <div class="d-flex justify-content-between w-75 mx-auto mt-5">
        ...
        <a href="/establishments/fsic/attachment/{{$establishment->id}}/fsic"  id="btnAttachments" class="btn btn-action rounded-0 fs-5 fsic-active">Attachments</a>
    </div>
    ...
    <div class="d-flex justify-content-end w-75 mx-auto pt-3">
        ...
        <div id="addAttachmentModal" class="modal" data-modal>
            ...
            <div class="modal-content" style="font-size: 0.9rem;">
                ...
                <form id="fileFormFsic" class="rounded-2 d-flex flex-column justify-content-center gap-3 mx-auto w-100" action="/establishments/attachment/fsic/{{$establishment->id}}/upload" method="POST" enctype="multipart/form-data" style="height: 250px;">
                    @csrf
...
<script>
    function uploadFile(){
        ...
        // Submit the file
        document.querySelector('#fileFormFsic').submit();
    }
