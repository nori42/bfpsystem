...
@section('content')
    <div class="page-content">
        ...
        <div class="w-75 mx-auto">
            ...
            <div>
                <p class="fs-5 mb-0"> Owner:
                    {{ $establishment->owner->last_name . ', ' . $establishment->owner->first_name . ' ' . $establishment->owner->middle_name }}
                </p>
            ...
            <div class="position-relative">
                <button type="button" class="btn btn-outline-success" style="width:auto !important" data-dropdown-btn
                    onclick="toggleShow('establishmentDetail',this)"><span
        ...
        <div class="d-flex justify-content-between w-75 mx-auto mt-5">
            <a href="/establishments/fsec/{{ $establishment->id }}" id="btnPayment"
                class="btn btn-action rounded-0 fs-5 fsic-active">Process</a>
            <a href="/establishments/fsec/attachment/{{ $establishment->id }}/fsec" id="btnAttachments"
                class="btn btn-action rounded-0 fs-5">Attachments</a>
        </div>
        ...
        <div id="fsec" class="w-75 h-75 overflow-y-auto mx-auto mt-4 border-3">
            ...
            <div class="d-flex justify-content-end">
                <button class="btn btn-success px-4" id="addPaymentBtn" onclick="openModal('addPaymentModal')">Add
                    Process</button>
            </div>
                    ...
                    <tbody>
                        @foreach ($establishment->evaluation as $evaluation)
                            <tr>
                                ...
                                <td class="text-center"><a href="/establishments/fsec/print/{{ $evaluation->id }}"
                                        class="btn btn-warning"><span class="material-symbols-outlined">print</span> </a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
