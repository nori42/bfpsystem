...
@section('content')
    ...
    <div class="page-content position-relative">
        ...
        <x-pageWrapper>
            ...
            <form class="mx-auto mt-3 py-3 px-5 position-relative" style="background-color: #EFEFEF;"
                    ...
                    <div class="position-relative">
                        ...
                        <div class="modal" id="dialogMoveToArchive" data-modal="modal">
                            <div class="modal-content w-50 modal-content-dialog">
                                ...
                                <p>Archived record cannot be access or edit <strong>(This action cannot be
                                        reverted)</strong>
                                </p>
                ...
                <div class="d-flex gap-2">
                    ...
                    <div class="my-2 w-100">
                        ...
                        <select class="form-select px-5 info" name="buildingType" id="buildingType" data-select-edit
                            disabled>
                ...
                <div class="d-flex gap-2">
                    ...
                    <div class="my-2 w-100">
                        ...
                        <input class="form-control info" type="text" value="{{ $establishment->height }}"
                            name="height" data-input-edit readonly>
                    </div>
                </div>
                ...
                <div class="my-2">
                    ...
                    <input class="form-control info" type="text" value="{{ $establishment->barangay }}"
                        name="barangay" data-input-edit readonly>
                </div>

                <div class="my-2">
                    <label class="info-label">Address</label>
                    <input class="form-control info" type="text" value="{{ $establishment->address }}"
                        name="address" data-input-edit readonly>
                </div>
            </form>
        </x-pageWrapper>
    </div>
