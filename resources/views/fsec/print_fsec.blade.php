...
<body>
    ...
    <div class="nav">
        ...
        <div class="printby">
            <strong>Owned By: </strong> <span>{{ $evaluation->establishment->owner->first_name }}
                {{ $evaluation->establishment->owner->last_name }} </span>
        </div>
        <div class="printby">
    ...
    <div id="printablePage">
        ...
        <div data-draggable="true" class="rep-name bold">
            <span>{{ $evaluation->establishment->owner->first_name }}
                {{ $evaluation->establishment->owner->middle_name }}
                {{ $evaluation->establishment->owner->last_name }}</span>
        </div>
